            ...
            <FavoriteProvider>
              ...
              <Router>
                ...
                <Routes>
                  ...
                  <Route
                    path="/popularbarcelona"
                    element={<PopularBarcelona />}
                  />
                  ...
                  <Route
                    path="ReferralFriendInfo"
                    element={<ReferralFriendinfo />}
                  />
                  <Route path="GiftCardInfo" element={<GiftCardInfo />} />
                  <Route
                    path="GiftCardPurchaseOptions"
                    element={<GiftCardPurchaseOptions />}
                  />
                  <Route
                    path="GiftCardInstructions"
                    element={<GiftCardInstructions />}
                  />
                  <Route
                    path="GiftCardPurchase"
                  ...
                  <Route
                    path="OwnerInfoDetails"
                    element={<OwnerInfoDetails />}
                  />
                  <Route
                    path="RegistrationStepper"
                    element={<RegistrationStepper />}
                  />
                  <Route path="OwnerInfoForm" element={<OwnerInfoForm />} />
                  <Route
                    path="RestaurantInfoForm"
                  ...
                  <Route
                    path="DinePointsDialog"
                    element={<DinePointsDialog />}
                  />
                  <Route path="GiftCardDialog" element={<GiftCardDialog />} />
                  <Route
                    path="RecommendFriendDialog"
                    element={<RecommendFriendDialog />}
                  />
                  <Route path="OpinionesDialog" element={<OpinionesDialog />} />
                  <Route
                    path="DatosPersonalesDialog"
                    element={<DatosPersonalesDialog />}
                  />
                  <Route
                  ...
                  <Route
                    path="CompletedReservation"
                    element={<CompletedReservation />}
                  />
                  <Route path="Reviews" element={<Reviews />} />
                  <Route path="LoginOwner" element={<LoginOwner />} />
                  <Route
                    path="ReservationsDialog"
                    element={<ReservationsDialog />}
                  />
                  <Route
                    path="RestaurantsDialog"
                    element={<RestaurantsDialog />}
                  />
                  <Route path="ReviewsDialog" element={<ReviewsDialog />} />
                  <Route
                    path="RestaurantDetailsDialog"
                    element={<RestaurantDetailsDialog />}
                  />
                  <Route path="QRCodeDialog" element={<QRCodeDialog />} />
                  <Route path="LeftDrawer" element={<LeftDrawer />} />
                  <Route
