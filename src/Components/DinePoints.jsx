  ...
  return (
    <Container>
      <ImageContainer>
        ...
        <StyledP>
          DINEBOOKER premia tu confianza y tu amor por la comida
        </StyledP>
      </ImageContainer>
      <DividerLeft />
      <InfoContainer>
        <InfoText>
          ...
          <p>
            Los DinePoints son los puntos de fidelidad que obtienes cuando
            reservas con DineBooker. Puedes canjearlos por descuentos de
            fidelidad de 10 € o 25 € en los restaurantes socios del programa.
            Estos descuentos no pueden acumularse con otras ofertas
            promocionales.
          </p>
        </InfoText>
        <CircleContainer>
