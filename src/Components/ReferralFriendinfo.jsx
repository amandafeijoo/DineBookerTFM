    ...
    <Container>
      ...
      <InfoContainer>
        <InfoBox>
          ...
          <Text>
            Invita a tus amigos compartiendo tu código que encuentras en tu
            perfil en el apartado de dinepoints.
          </Text>
        </InfoBox>
        <InfoBox>
          <FontAwesomeIcon
          ...
          <Text>
            Tiene que hacer su primera reserva con tu código que le has
            compartido.
          </Text>
        </InfoBox>
        <InfoBox>
