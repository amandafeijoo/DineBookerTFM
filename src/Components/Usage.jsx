    ...
    <>
      ...
      <Container>
        <Section>
          ...
          <StyledH5>
            Recomendaciones y opiniones de una magnifíca comunidad.
          </StyledH5>
        </Section>
        <Section>
          ...
          <StyledH5>
            Reservar inmediata,gratuita y estés donde estés. Las 24 horas, los 7
            dias de la semana.
          </StyledH5>
        </Section>
        <Section>
          ...
          <StyledH5>
            Ofertas en multitud de restaurantes y muchas otras ventajas con
            nuestro programa DinePoints.
          </StyledH5>
        </Section>
        <Section>
          ...
          <StyledH5>
            Una selección inigualable de restaurantes para todo lo que quieras
          </StyledH5>
        </Section>
      </Container>
    </>
